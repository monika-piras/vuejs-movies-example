  ...
  <div>
    <form @submit="checkForm">
      ...
      <div class="form-group align-left custom-control custom-switch ">
        <input type="checkbox" class="custom-control-input" id="customSwitches" v-model="prefer">
        <label class="custom-control-label" for="customSwitches">ADD TO FAVOURITES</label>
      </div>
